...
setup(name='DynamicForm',
      ...
      download_url='https://github.com/timothycrosley/DynamicForm/blob/master/dist/DynamicForm-0.5.1.tar.gz?raw=true',
      license = "GNU GPLv2",
      install_requires=['webelements>=1.0.0-alpha.19',],
